    ...
    <section className="section banner-home2 mb-50">
      <div className="box-banner-homepage-2">
        <div
          ...
          style={{
            backgroundImage:
              "url(assets/imgs/MechaniCar-Banner-design-New_3.jpg)",
          }}
        ></div>
        <div className="box-banner-info">
          <p className="text-16 color-white wow fadeInUp">
            Your Trusted partner for quality car repairs and maintenance{" "}
          </p>
          <h2 className="heading-52-medium color-white wow fadeInUp">
            Welocme to Direct  <br className="d-none d-lg-block" />
            Garage  Services
          </h2>
          <div className="mt-20">
            <Link className="btn btn-border wow fadeInUp" href="/">
              View Our Sevices
              <svg
                className="icon-16"
                fill="none"
