          ...
          <div className="col-lg-5 mb-30">
            <div className="box-image-showcase wow fadeInUp">
              <Image
                width={1410}
                height={1650}
                src="/assets/imgs/1410 x 1650.jpg"
          ...
          <div className="col-lg-7 mb-30">
            ...
            <h2 className="heading-44-medium color-text mb-30 wow fadeInUp">
              ...
              <p className="text-16 color-text mb-30 wow fadeInUp">
                With over a decade of experience in automotive service, our certified mechanics
                provide expert care for all makes and models. From routine maintenance to
                complex repairs, we ensure your vehicle runs at its best.
              </p>
              <div className="row align-items-center">
                {facts.map((elm, i) => (
